...
class PokerHandTest {
  ...
  public void otherTests() {
    test("Full house should win straight (even if it is not correct though)", loss, "3S 8S 9S 5S KS", "KH KC 3S 3H 3D");
    test("comparing highest cards", loss, "JH 8S TH AH QH", "TS KS 5S 9S AC");
  }
